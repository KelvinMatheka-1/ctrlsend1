    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case TransactionWithdrawalRow:
            return TransactionWithdrawalRow(data);
          case TransactionsDuplicateRow:
            return TransactionsDuplicateRow(data);
          case UsersRow:
            return UsersRow(data);
          case WithdrawRequestRow:
            return WithdrawRequestRow(data);
          default:
            return null;
        }
